...
// Query untuk mengambil data bank sampah dari database
$sql = "SELECT region, COUNT(bank_id) AS total_banks, GROUP_CONCAT(bank_operating_hours SEPARATOR ', ') AS operating_hours
        FROM bank_locations
        GROUP BY region";
