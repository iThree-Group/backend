...
<body class="font-poppins">
   ...
   <div class="navbar bg-light h-[92px] pr-[41px] justify-between">
    ...
    <!-- DESKTOP MODE -->
        ...
        <a href="./request_dropoff.php" class="btn btn-success w-full shadow-[0px_4px_4px_-0px_rgba(0,0,0,0.25)] rounded-[20px] flex px-2.5 content-center text-light text-base font-medium gap-2">
          <img src="./images/truck.png" class="w-10" alt="Drop Off Icon">
    ...
    <?php if (!isset($_SESSION['user_email'])): ?>
        ...
        <a href="./user/signin.php" class="btn px-5 h-[42px] shadow-[0px_4px_4px_-0px_rgba(0,0,0,0.25)] rounded-[20px] bg-gradient-to-r from-green to-dark-green text-[20px] border-dark border-[1px] font-medium text-light">Sign In</a>
    ...
    <?php else: ?>
        <!-- Hide Sign In and Sign Up buttons if logged in -->
        <div tabindex="0" role="button" class="btn btn-ghost btn-circle avatar">
            <div class="w-[50px] rounded-full">
                <!-- You can replace the image with user's profile picture if available -->
